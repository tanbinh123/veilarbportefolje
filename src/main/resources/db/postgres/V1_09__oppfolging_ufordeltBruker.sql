ALTER TABLE OPPFOLGING_DATA ADD ER_UFORDELT boolean default true;
...
SELECT OD.AKTOERID, OD.OPPFOLGING,OD.STARTDATO, OD.NY_FOR_VEILEDER, OD.VEILEDERID, OD.ER_UFORDELT, OBA.FODSELSNR, OBA.FORNAVN, OBA.ETTERNAVN, OBA.NAV_KONTOR, OBA.DISKRESJONSKODE
FROM OPPFOLGING_DATA OD
         LEFT JOIN OPPFOLGINGSBRUKER_ARENA OBA ON OBA.AKTOERID = OD.AKTOERID;