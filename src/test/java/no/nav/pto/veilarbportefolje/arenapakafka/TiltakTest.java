...
public class TiltakTest {
    ...
    @Autowired
    public TiltakTest(TiltakRepository tiltakRepository, TiltakRepositoryV2 tiltakRepositoryV2, JdbcTemplate jdbcTemplate, AktivitetDAO aktivitetDAO) {
        ...
        this.tiltakServiceV2 = new TiltakServiceV2(tiltakRepository, tiltakRepositoryV2,aktorClient, arenaHendelseRepository, mock(BrukerDataService.class), mock(ElasticIndexer.class));
    }
